  ...
  return (
    <>
     <ScrollTrigger
      ...
      >
        <div data-aos="fade-up"  data-aos-duration="2000" className='bg-[#383838] max-w-[90%] mx-auto rounded-[20px]'>
          

          <div className="grid grid-cols-3 gap-8 my-16 py-16 px-4 text-white max-md:mb-0 max-md:mt-8 max-md:flex  max-md:flex-col max-md:gap-4 max-md:py-8">
