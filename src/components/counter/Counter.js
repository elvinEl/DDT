        ...
        <div data-aos="fade-up"  data-aos-duration="2000" className='bg-[#fdeeee] max-w-[90%] mx-auto rounded-[20px]'>
          ...
          <div className="grid grid-cols-3 mt-16 mb-16 pt-16 pb-16 text-black max-md:mb-0 max-md:mt-8 max-md:flex  max-md:flex-col max-md:gap-4">
            <div className="flex flex-col justify-center items-center">
              <div className="flex text-[50px] max-md:text-[30px]">
                {counterStart && (
              ...
              <p className="text-[32px] max-md:text-[24px] text-center"> Hazırlanmış sayt</p>
            ...
            <div className="flex flex-col justify-center items-center">
              ...
              <div className='flex flex-col'>
              <p className="text-[32px] max-md:text-[24px] text-center">Əməkdaş</p>
                <span className='text-center'>
            ...
            <div className="flex flex-col justify-center items-center">
              ...
              <div className='flex flex-col'>
              <p className="text-[32px] max-md:text-[24px] text-center">İllik Təcrübə</p>
                <span className='text-center'>
