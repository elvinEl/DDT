...
function Footer() {
  return (
    <>
    <div >
    <div  className="w-[60%] absolute left-[0px] h-[325px]">
        <iframe
      ...
      <div className="clip_path bg-gradient-to-br from-[#e9ffd4] via-[#f5bfd7] to-[#4dc9e6] absolute right-[0px] w-[60%] ">
        <div className="pt-8">
          ...
          <div className="pl-24 pt-12 pb-8  grid grid-cols-3">
            ...
            <div>
              ...
              <div className="flex flex-col   ">
                <NavLink className='pt-3 text-[18px]' to="/">Ana Səhifə</NavLink>
                <NavLink className='pt-3 text-[18px]' to="/about">Haqqımızda</NavLink>
                <NavLink className='pt-3 text-[18px]' to="/portfolio">Portfolio</NavLink>
                <NavLink className='pt-3 text-[18px]' to="/connect">Əlaqə</NavLink>
              </div>
            </div>
          </div>
        </div>
