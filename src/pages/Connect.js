  ...
  useEffect(() => {
    async function fetchContact() {
      ...
      const response = await axios.get(
        "http://10.138.1.35:8000/api/v1/general-data",
        {
    ...
    <>
      ...
      >
        ...
        {Object.keys(contact).map((key) => (
            <div className={`connect/${contact[key]} grid grid-cols-3 max-w-[90%] mt-8 gap-4 mx-auto max-lg:grid-cols-2 max-md:grid-cols-1`}>
